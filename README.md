...
### Prerequisites
To run the executable, the following OpenSSL 3.x libraries must be present in the same folder:
* `libcrypto-3-x64.dll`
* `libssl-3-x64.dll`
...
## ⚖️ License
Academic Evaluation License. This project is part of a potential patent disclosure. Commercial use, redistribution, or reverse engineering is strictly prohibited.
